    ...
    try:
        ...
        for assertion in assertions:
            ...
            # JSON Body Assertions
                ...
                print(f'Actula value of headers  : {actual_value}')

                if actual_value is not None and assertion.regex:
                    match = re.search(assertion.regex, actual_value)
                    print(f"match groups :,{match}")
                    
                    
                    if match:
                        print(f"match groups :,{match.groups()} : {match.group(0)}")
                ...
                if actual_value is not None:
                    print(f"assertion Expected Type : {assertion.expectedValue}, {actual_value}")
            ...
            print(f"Test this Assertion Result: {assertion_result}")
    except Exception as e :
        print(f"Texas Image Error Regex: {e}")
